...
def preview():
    if request.method == 'POST':
        ...
        return render_template("preview.html", df_view=df.head(50)) 
...
def predict():
    if request.method == 'POST':
        try:
            ...
            # Fuel type encoding
            fuel_raw = request.form['Fuel_Type_Petrol']
            if fuel_raw == 'Petrol':
                Fuel_Type_Petrol = 1
                Fuel_Type_Diesel = 0
            elif fuel_raw == 'Diesel':
                Fuel_Type_Petrol = 0
                Fuel_Type_Diesel = 1
            else:
                Fuel_Type_Petrol = 0
            ...
            seller_raw = request.form['Seller_Type_Individual']
            Seller_Type_Individual = 1 if seller_raw == 'Individual' else 0

            # Transmission encoding
            trans_raw = request.form['Transmission_Mannual']
